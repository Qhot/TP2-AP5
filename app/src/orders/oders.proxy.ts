...
export default class OrderProxy implements IService {
    ...
    // Je n'arrive pas à utiliser la méthode parent alors on contourne de façon pas très jolie jolie.
    ...
    async create(orderInformations: any): Promise<Order> {
    ...
    async getAll (): Promise<Order[]> {
        ...
        let orderArray: Order[] = await this.service.getAll();
    ...
    async update(id: number, updateInformations: any): Promise<boolean> {
